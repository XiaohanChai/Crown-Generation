...
vq_model="GraphVAE"
vq_yaml="vae_${dataset_mode}_eval_test.yaml"
vq_cfg="configs/${vq_yaml}"
# vq_ckpt="saved_ckpt/vae-ckpt/vae-shapenet-depth-8.pth"
vq_ckpt="/root/octfusion/logs/crown_union/test_snet_lr1e-3/ckpt/vae_steps-latest.pth"
...
if [ $mode = "train" ]; then
    ...
    ckpt="/root/octfusion/logs/crown_union/union_2t_test_lr2e-4/ckpt/df_steps-latest.pth"
fi
...
# sh scripts/run_snet_uncond_test.sh train lr mytest 