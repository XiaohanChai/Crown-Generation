...
def config_dataloader(opt):
	...
	if opt.category == 'mask_crown_350':
		flags_train.filelist = os.path.join(flags_train.filelist, 'mask_crown_350_2.txt')
		flags_test.filelist = os.path.join(flags_test.filelist, 'mask_crown_350_2.txt')
	else:
